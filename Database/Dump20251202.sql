...
INSERT INTO `album` VALUES (3,'Tuyển tập Chillout 2022','2022-11-20','\\media\\images\\album1.jpg',NULL,2,1,'2025-11-02 05:13:52','2025-11-03 13:25:22'),(4,'Blue Notes','2019-05-10','\\media\\images\\album1.jpg',NULL,3,1,'2025-11-02 05:13:52','2025-11-03 13:25:22'),(7,'em','2025-11-22','https://pub-1f9b74cb44204e84b3dd30bb4df6a1e2.r2.dev/albums/1764796472459-1764312502996-Ã¡ÂºÂ¢nh chÃ¡Â»Â¥p mÃÂ n hÃÂ¬nh 2025-11-19 091950.png',NULL,23,1,'2025-11-06 03:26:52','2025-12-04 04:14:32'),(8,'TheWeeknd','2025-11-22','\\media\\images\\album1.jpg',NULL,29,1,'2025-11-28 02:17:16','2025-12-02 01:55:50'),(9,'Ophelia',NULL,NULL,NULL,31,1,'2025-12-01 00:29:38','2025-12-01 00:29:38'),(13,'a','2000-02-20','/uploads/covers/bc1010ece72ec679eaa4d4101edb3ec10d92.jpg',NULL,23,0,'2025-12-02 04:11:41','2025-12-02 04:11:50'),(14,'b','2026-02-20','/uploads/covers/50cb80f3f89a01c878252aba6148b107b.jpg',NULL,23,0,'2025-12-02 15:54:38','2025-12-02 15:54:50'),(15,'an','2025-02-20','https://pub-1f9b74cb44204e84b3dd30bb4df6a1e2.r2.dev/albums/1764796427466-1764312006145-Ã¡ÂºÂ¢nh chÃ¡Â»Â¥p mÃÂ n hÃÂ¬nh 2025-11-04 002541.png',NULL,23,1,'2025-12-04 04:13:48','2025-12-04 04:13:48');
...
CREATE TABLE `artist` (
  ...
  `active` tinyint(1) DEFAULT '1',
  `registration_status` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'PENDING' COMMENT 'PENDING, APPROVED, REJECTED',
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `category` (
  ...
  `slug` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'URL thân thiện',
  `description` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `image_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Link ảnh bìa của thể loại',
  PRIMARY KEY (`id`),
...
INSERT INTO `follow` VALUES (28,2,0,'2025-11-08 01:15:01'),(28,3,0,'2025-11-09 22:43:06'),(28,4,1,'2025-11-08 01:11:40'),(28,6,0,'2025-11-08 01:12:07'),(28,7,0,'2025-11-09 22:43:14'),(28,29,0,'2025-12-01 20:55:18'),(33,3,1,'2025-11-09 21:36:48'),(33,4,1,'2025-11-09 21:06:27'),(33,6,1,'2025-11-09 21:36:56');
...
INSERT INTO `history` VALUES (59,28,17,2,'2025-12-01 20:17:18'),(60,28,8,2,'2025-12-01 20:20:56'),(61,28,17,2,'2025-12-01 20:21:39'),(62,28,17,2,'2025-12-01 20:22:36'),(63,28,5,2,'2025-12-01 20:29:56'),(64,28,8,2,'2025-12-01 20:34:00'),(65,28,15,2,'2025-12-01 20:51:58'),(66,28,15,2,'2025-12-01 20:54:58'),(67,28,8,2,'2025-12-01 21:08:53'),(68,28,15,2,'2025-12-01 21:20:47'),(69,28,8,2,'2025-12-01 21:21:04'),(70,28,6,2,'2025-12-01 21:21:16'),(71,28,17,2,'2025-12-01 21:21:42'),(72,28,15,2,'2025-12-01 21:30:34'),(73,28,7,2,'2025-12-01 21:30:41'),(74,28,8,2,'2025-12-01 21:30:59'),(75,28,6,2,'2025-12-03 21:23:28'),(76,28,6,2,'2025-12-03 21:42:19');
...
CREATE TABLE `lyrics` (
  `id` int NOT NULL AUTO_INCREMENT,
  `song_id` int NOT NULL,
  `lyrics` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `language` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'vi' COMMENT 'vi, en, ...',
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
INSERT INTO `playlist` VALUES (24,28,'a',0,'2025-11-08 05:56:06','2025-12-02 04:08:20',0),(26,28,'a',0,'2025-12-02 04:08:34','2025-12-02 16:00:27',0),(27,28,'m',1,'2025-12-02 04:45:03','2025-12-02 04:45:03',0);
...
INSERT INTO `playlist_songs` VALUES (26,8,'2025-12-02 04:08:53',0,1,0),(27,17,'2025-12-02 16:00:41',0,2,0);
...
CREATE TABLE `report` (
  ...
  `status` enum('PENDING','IN_REVIEW','RESOLVED','REJECTED') COLLATE utf8mb4_unicode_ci DEFAULT 'PENDING',
  ...
  KEY `user_id` (`user_id`),
  KEY `song_id` (`song_id`),
  CONSTRAINT `report_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE CASCADE,
  CONSTRAINT `report_ibfk_2` FOREIGN KEY (`song_id`) REFERENCES `song` (`id`) ON DELETE CASCADE
...
INSERT INTO `report` VALUES (1,28,6,'ko phù hợp','','PENDING',NULL,'2025-12-03 21:42:58','2025-12-03 21:42:58');
...
CREATE TABLE `song` (
  ...
  `image_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Ảnh bìa riêng của bài hát',
  ...
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `genre` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Thể loại của bài hát (Pop, Rock,...)',
...
CREATE TABLE `user` (
  ...
  `password` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Mã hóa bằng bcrypt',
  `role_id` int NOT NULL,
  `gender` enum('male','female','other','prefer not to say') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'prefer not to say' COMMENT 'Giới tính',
...
INSERT INTO `userlikedsongs` VALUES (28,8,'2025-11-08 02:53:08');
...
-- Dump completed on 2025-12-04  4:59:50
